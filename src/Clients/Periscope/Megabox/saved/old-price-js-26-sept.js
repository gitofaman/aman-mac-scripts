var updateUserForm = (fieldsJson, attr) => {
    ...
    // if(mStorageIndex === 0) {
    //     mStorage = '1 Month'
    // } else if(mStorageIndex === 1) {
    //     mStorage = '6 Months - 12 Months'
    // } else {
    //     mStorage = '12 Months++'
    // }
...
var servicePrices = [0, 99, 149, 289]
...
function pricingCalculator(service, neededSpace, timeToStore, postcode, valuesObj, formName) {
    ...
    if (spaceIndex >= 0 && storeIndex >= 0 && serviceIndex >= 0) {
        ...
        totalPrice = (monthlyRate * numOfMonths) + zoneFee + deliveryRate + redeliveryRate;
...
function pricingCalculatorSelf(neededSpace, timeToStore, valuesObj, formName) {
    ...
    if (spaceIndex >= 0 && storeIndex >= 0) {
        ...
        totalPrice = (monthlyRate * numOfMonths)
...
var updatePrice = (formName) => {
    ...
    jsonDataToSend.customerName = findValue('ame', valuesObj)
