        ...
        if (!addedFiltersscript) {
            $(document).ready(function () {
                ...
                function filterItems() {
                    ...
                    // Standard checkbox/radio filters
                    ...
                    $Fblock.find('.form_checkbox.is-custom .form_cbox-icon.is-checked').each(function () {
                        var filterField = $(this).siblings('[fs-cmsfilter-field]');
                        if (filterField.length) {
                            var identifier = filterField.attr('fs-cmsfilter-field');
                            var filterBy = filterField.attr('filter-by');
                ...
                $Fblock.find('.form_checkbox.is-custom').on('click', function () {
