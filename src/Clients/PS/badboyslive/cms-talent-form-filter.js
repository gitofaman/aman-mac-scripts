        ...
        if (!addedFiltersscript) {
            $(document).ready(function () {
                ...
                function filterItems() {
                    ...
                    $Fblock.find('input[type=checkbox]:checked, input[type=radio]:checked').each(function () {
                        var filterField = $(this).siblings('span[fs-cmsfilter-field]');
                        if (filterField.length) {
                            ...
                            selectedFilters[identifier].push(filterText);
                        }
                    });
                    ...
                    filteredItems = $CItems.filter(function () {
                        ...
                        // Check each identifier in selectedFilters
                        for (var identifier in selectedFilters) {
                            var itemField = $(this).find('[fs-cmsfilter-field=' + identifier + ']');
                            if (itemField.length) {
                                var itemText = itemField.text().trim();
    
                                // If the item text does not match any selected filter text, it's not a match
                                if (!selectedFilters[identifier].includes(itemText)) {
                                    match = false;
                                    break;
                                }
                            } else {
